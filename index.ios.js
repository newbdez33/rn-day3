    ...
    return(
        <View style={styles.weatherContainer}>
            <View>
                ...
                <TouchableHighlight onPress={()=>this.info()} style={styles.backBtn}>
